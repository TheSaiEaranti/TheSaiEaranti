...
| **[cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs/pull/32497)** <br> <sub>Cloudflare docs · 4k+ ★</sub> | Documented the `--infer-origin-from-routes` flag for `wrangler dev`, requested by the reviewer of the companion workers-sdk PR. | ![Open](https://img.shields.io/badge/open-238636?style=flat-square) |
